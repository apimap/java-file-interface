...
import io.apimap.file.taxonomy.TaxonomyDataWrapper;
...
public class TaxonomyFileTest {
    ...
    public void allContent_didSucceed() throws MissingRequiredFieldException, UnsupportedVersionException {
        ...
        TaxonomyFile file = new TaxonomyFile(TaxonomyFile.SUPPORTED_VERSION, data);
        assertTrue(file.validContent());
    }
}